...
| 技术栈 | JDK 17、Maven 3.8.x、Spring Boot 3.5.16、MySQL 8、Redis、Node.js 24.x LTS（基线 24.18.0）、Vue 3.5.39、Vite 8.1.3、TypeScript 6.0.3、Element Plus 2.14.2、Pinia 3.0.4、Vue Router 4.6.4、Axios 1.18.1、npm 等最小栈不再新增 | 待维护者确认 |
...
| 模型数据与出站安全 | 数据分类、最小化、脱敏、权限过滤、出境风险提示和 API Base SSRF/DNS/TLS 门禁接受 | 待维护者确认 |
| 开源合规 | 开发包必须有 runtime manifest/NOTICE；生产包必须有 runtime manifest、依赖 manifest、NOTICE，且来源、版本、许可证和 SHA256 可追踪 | 待维护者确认 |
